    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <form action="<?= isset($page) ? '/admin/pages/update/' . $page['id'] : '/admin/pages/store' ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label for="background">Foto de Destaque</label>
                    <input type="file" name="photo_destaque" class="form-control" id="photo_destaque">
                    <?php if (isset($page) && $page['photo_destaque']): ?>
                        <img src="/uploads/<?= esc($page['photo_destaque']) ?>" alt="photo destaque" width="200">
                    <?php endif; ?>
                </div>
