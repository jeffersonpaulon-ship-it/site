...
class Filters extends BaseFilters
{
    ...
    public array $required = [
        ...
        'after' => [
            ...
            // 'toolbar', // Desativado em produção: veja o comentário em $globals['after'] abaixo.
        ],
    ];
    ...
    {
        log_message('debug', 'Método loginPage iniciado');
        if (session()->get('isLoggedIn')) {
            log_message('debug', 'Usuário já está logado, redirecionando para o dashboard');
            return redirect()->to('/admin/dashboard');
        }
        log_message('debug', 'Renderizando página de login');
