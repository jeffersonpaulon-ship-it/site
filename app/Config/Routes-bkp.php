 ...
 */
// Grupo de rotas para admin (com filtro de autenticação aplicado)
...
// Rotas específicas para itens conhecidos
...
// Rota genérica para capturar páginas dinâmicas com o PageController
$routes->get('(:any)', 'PageController::index/$1');